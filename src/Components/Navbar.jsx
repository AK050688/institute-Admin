...
const Navbar = () => {
    ...
    return (
        <nav className="text-white flex justify-between items-center p-4 mr-4 text-2xl font-bold fixed t-0 w-full bg-black">
            <div></div>
            <div className="tracking-wide">Admin Dashboard</div>
            <div className="mr-[13%] m-auto" ref={profileRef} onClick={toggleProfile} style={{ cursor: "pointer" }}>
                <CgProfile />
            </div>
            {profile && (
                <div className="flex items-end mr-6 mt-[220px] absolute right-0 z-50">
                    <div className="w-[180px] h-[170px] bg-blue-300 rounded-md">
